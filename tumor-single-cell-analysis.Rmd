...
author: Erick Lu
date: "February 12, 2020 \n\n[GitHub Repo](https://github.com/erilu/single-cell-rnaseq-analysis)"
output:
  html_document:
    toc: true
    toc_float: true
...
```{r}
# Read in data
raw_data <- Read10X(data.dir = "./GSE110746")
```
...
grep("^mt-", rownames(b16@assays$RNA), value = T)
grep("Rps|Rpl|Mrpl|Mrps", rownames(b16@assays$RNA), value = T)
```
